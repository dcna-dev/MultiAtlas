...
public class SynchronousSimulationExample1 {
     ...
     */
    private static final double INTERVAL = 600;
    ...
    public CloudSimPlus simulation;
    ...
    public List<Double> vmCpuUtilization = new ArrayList<>();
    ...
    public void printVmCpuUtilization() {
        ...
        for (final Vm vm : vmList) {
            vmCpuUtilization.add(vm.getCpuPercentUtilization());
